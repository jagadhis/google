export default {
  ...
  searchInformation: {
    searchTime: 0.72383,
    formattedSearchTime: "0.72",
    totalResults: "363000000",
    formattedTotalResults: "363,000,000",
  },
  items: [
    {
    ...
    },
    {
      ...
      pagemap: {
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2Kp5YjKJwAUASK5hwNn0EJwg_I-jBwLy4ihcVZGzHgw0BQYl2Zv-nlQ",
            width: "150",
            height: "40",
          },
        ],
    ...
    },
    {
      ...
      displayLink: "www.tesla.com",
      snippet:
        "With the longest range and quickest acceleration of any electric vehicle in production, Model S Plaid is the highest performing sedan ever built. Both Long ...",
      htmlSnippet:
        "With the longest range and quickest acceleration of any electric vehicle in production, Model S Plaid is the highest performing sedan ever built. Both Long&nbsp;...",
    ...
    },
    {
      ...
      displayLink: "www.tesla.com",
      snippet:
        "Model X is built for utility and performance, with standard AWD, best in class storage and seating for up to seven.",
      htmlSnippet:
        "Model X is built for utility and performance, with standard AWD, best in class storage and seating for up to seven.",
    ...
    },
    {
      ...
      pagemap: {
        ...
        cse_thumbnail: [
          {
            src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxkOe2PV_s0i_PgX5VBmuRDoYfZsduA0ByL9rxjPrRbXTUd_BbkhfqosWo",
            width: "194",
            height: "260",
          },
        ],
